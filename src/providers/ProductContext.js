...
const ProductContext = ({ children }) => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await fetch("https://fruits-heaven-api.vercel.app/api/v1/product?PageCount=1000&deleted=false&available=true&isTopProduct=true"); // Replace with your API URL
