                  ...
                  <table className="table">
                    <tbody>
                      <tr>
                        <td>{t('Items Price')}</td>
                        <td>
                          {modifyAmount(currentProducts?.subTotal)}{' '}
                          <svg
                            id="Layer_1"
                            data-name="Layer 1"
                      ...
                      {currentProducts?.discount && (
                        <tr>
                          <td>{t('Discount')}</td>
                          <td>
                            {modifyAmount(currentProducts?.discount)}{' '}
                            <svg
                              id="Layer_1"
                              data-name="Layer 1"
                              xmlns="http://www.w3.org/2000/svg"
                      ...
                      <tr>
                        ...
                        <td>
                          <strong>
                            {Number(currentProducts?.totalPrice).toFixed(2)}{' '}
                            <svg
                              id="Layer_1"
                              data-name="Layer 1"
                              xmlns="http://www.w3.org/2000/svg"
