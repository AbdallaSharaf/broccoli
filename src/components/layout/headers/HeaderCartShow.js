            ...
            {headerStyle === 5 ? (
              <h6>
                ...
                <span className="ltn__secondary-color">
                  {cartProducts?.totalPrice && modifyAmount(cartProducts?.totalPrice)} <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1124.14 1256.39" width="16" height="16">
